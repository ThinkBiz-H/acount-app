  ...
  Future<void> _downloadPdf(
    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [pw.Text("ACCOUNT STATEMENT")],
      ),
    );
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          /// ✅ CHAT STYLE LIST (SAME AS SUPPLIER)
          Expanded(
